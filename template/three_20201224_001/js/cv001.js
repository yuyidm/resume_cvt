(function () {
    let cvt = 'cvt_three_20201224',
        version = 'v1608687212342'
    ...
    <template v-for="key in cvData.modules">
        <template v-if="key === 'm002'">
            ...
            >院校教育
                <div><div v-style.bgc="color"></div><div v-style.bgc="color"><img src="/static/template/resume/${cvt}/${version}/img/title.png" alt=""></div></div>
            </div>
    ...
    RESUMES[cvt] = {
        ...
        version,
        // 配色
        colors: ['#7da38c', '#e3b176', '#7f9eb2', '#f8cccc', '#a3a7ae'],
        // 间距基准值
        padding: 20,
        // 字体大小基准值
        fontSize: 16,
