(function () {
    let cvt = 'cvt_double_20201223',
        version = 'v1608707299547'
    ...
    >
        <div>
            ...
            <div class="swap_flex" v-if="m001.user_phone">
                <div class="icon">
                    <img src="/static/template/resume/${cvt}/${version}/img/phone.png" alt="" />
                </div>
            ...
            <div class="swap_flex" v-if="m001.user_wechat">
                <div class="icon">
                    <img src="/static/template/resume/${cvt}/${version}/img/wechat.png" alt="" />
                </div>
                <div class="left_border_000 text_eee"
                     v-style.fs="fontSize - 2"
                     v-style.pb="padding - 4"
            ...
            <div class="swap_flex" v-if="m001.user_qq">
                <div class="icon">
                    <img src="/static/template/resume/${cvt}/${version}/img/qq.png" alt="" />
                </div>
                <div class="left_border_000 text_eee"
                     v-style.fs="fontSize - 2"
                     v-style.pb="padding - 4"
            ...
            <div class="swap_flex" v-if="m001.user_email">
                <div class="icon">
                    <img src="/static/template/resume/${cvt}/${version}/img/email.png" alt="" />
                </div>
                <div class="left_border_000 text_eee"
                     v-style.fs="fontSize - 2"
                >
        ...
        <div style="display: flex; flex-direction: column; align-items: flex-end">
            <div class="image"
                ...
                <img src="/static/template/resume/${cvt}/${version}/img/top_icon.png" alt="" />
            </div>
            <div class="text_eee" 
                 v-style.fs="fontSize - 2"
    ...
    let swap = Vue.extend({
        ...
        template: `
            <div>
            <div ref="swap1" class="${cvt} cvt_swap cvt_swap1"></div>
    ...
    RESUMES[cvt] = {
        ...
        version,
        // 配色
        colors: ['#F5B600', '#7074D8', '#434979', '#FA6664', '#0EA76E'],
        // 间距基准值
        padding: 20,
        // 字体大小基准值
        fontSize: 16,
