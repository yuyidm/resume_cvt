(function () {
    let cvt = 'cvt_double_20201225',
        version = 'v1608878651703'
    ...
    let swap = Vue.extend({
        ...
        template: `
            <div>
            <div ref="swap1" class="${cvt} cvt_swap cvt_swap1" v-style.bgc="color"></div>
    ...
    RESUMES[cvt] = {
        ...
        version,
        // 配色
        colors: ['#515459', '#1B1A18', '#404B5E', '#476762', '#293F5A'],
        // 间距基准值
        padding: 20,
        // 字体大小基准值
        fontSize: 16,
